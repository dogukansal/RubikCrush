...
import kotlinx.android.synthetic.main.activity_four_color_three.*
import java.lang.Exception

class FourColorThree : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_four_color_three)
        textView8.text = ""+sayac
        val rnds :ArrayList<Int> = arrayListOf<Int>()
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            imageButton412, imageButton413, imageButton414, imageButton418, imageButton419, imageButton420,imageButton424, imageButton425, imageButton426,
            imageButton415, imageButton416, imageButton417, imageButton421, imageButton422, imageButton423, imageButton427, imageButton428, imageButton429,
            imageButton430, imageButton431, imageButton432, imageButton436, imageButton437, imageButton438, imageButton442, imageButton443, imageButton444,
            imageButton433, imageButton434, imageButton435, imageButton439, imageButton440, imageButton441, imageButton445, imageButton446, imageButton447)
        for (z in 0..35){
            val a = (0..11).random()
            rnds.add (a)
    ...
    var adRequest2 = AdRequest.Builder().build()
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/4027216949", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma1(imageButton412)==-5242848 && renkidalma1(imageButton413)==-5242848 && renkidalma1(imageButton424)==-5242848 &&
            ...
            renkidalma1(imageButton418)==-5242848 && renkidalma1(imageButton420)==-5242848 && renkidalma1(imageButton426)==-5242848 &&
            //kırmızı
            renkidalma1(imageButton433)==-16777216 &&  renkidalma1(imageButton439)==-16777216 &&  renkidalma1(imageButton445)==-16777216 &&
            renkidalma1(imageButton434)==-16777216 &&  renkidalma1(imageButton440)==-16777216 &&  renkidalma1(imageButton446)==-16777216 &&
            ...
            renkidalma1(imageButton416)==-16776961 && renkidalma1(imageButton422)==-16776961 && renkidalma1(imageButton428)==-16776961 &&
            ...
            renkidalma1(imageButton431)==-10053376 && renkidalma1(imageButton437)==-10053376 && renkidalma1(imageButton443)==-10053376 &&
...

        {
            try {
                ...
                val cursor1 = veritabani.rawQuery("SELECT * FROM oyun8", null)
                ...
                if (deneme == 0) {
                    veritabani.execSQL("INSERT INTO oyun8 (id , color4sizee3 ) VALUES (1,$sayac)") // ilk başta veri yoksa tanımla
                } else {
                    if (sayac < deneme) {  // veri varsa bunu yap
                        veritabani.execSQL("INSERT OR IGNORE INTO oyun8 (id , color4sizee3 ) VALUES (1,$sayac)")
                    }
                }
            }
            catch (e : Exception){
    ...
    fun a22yan (view : View) {
        render(imageButton418, imageButton419, imageButton420, imageButton421, imageButton422, imageButton423 )
        sayac++
        textView8.text = ""+sayac
    }
    ...
    fun a55yan (view : View) {
        render(imageButton436, imageButton437, imageButton438, imageButton439, imageButton440, imageButton441)
        sayac++
        textView8.text = ""+sayac
    }
