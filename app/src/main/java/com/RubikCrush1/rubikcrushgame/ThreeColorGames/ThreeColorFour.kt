...
import kotlinx.android.synthetic.main.activity_three_color_four.*
import java.lang.Exception

class ThreeColorFour : AppCompatActivity() {
    private var mInterstitialAd: InterstitialAd? = null
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_three_color_four)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            ...
            imageButton291, imageButton292,imageButton293,imageButton294,
            imageButton299, imageButton300,imageButton301,imageButton302,
            imageButton307, imageButton308,imageButton309,imageButton310,
            imageButton319, imageButton320, imageButton321, imageButton322,
            imageButton327, imageButton328, imageButton329, imageButton330,
            imageButton335, imageButton336, imageButton337, imageButton338,
            imageButton343, imageButton344, imageButton345, imageButton346,
            imageButton287, imageButton288, imageButton289, imageButton290,
            imageButton295, imageButton296, imageButton297, imageButton298,
            imageButton303, imageButton304, imageButton305, imageButton306,
            imageButton311, imageButton312, imageButton313, imageButton314,
            imageButton315, imageButton316,imageButton317,imageButton318,
            imageButton323, imageButton324,imageButton325,imageButton326,
            imageButton331, imageButton332,imageButton333,imageButton334,
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/3067883711", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma111(imageButton283)==-5242848 && renkidalma111(imageButton284)==-5242848 && renkidalma111(imageButton285)==-5242848 && renkidalma111(imageButton286)==-5242848 &&
            renkidalma111(imageButton291)==-5242848 && renkidalma111(imageButton292)==-5242848 && renkidalma111(imageButton293)==-5242848 && renkidalma111(imageButton294)==-5242848 &&
            renkidalma111(imageButton299)==-5242848 && renkidalma111(imageButton300)==-5242848 && renkidalma111(imageButton301)==-5242848 && renkidalma111(imageButton302)==-5242848 &&
            renkidalma111(imageButton307)==-5242848 && renkidalma111(imageButton308)==-5242848 && renkidalma111(imageButton309)==-5242848 && renkidalma111(imageButton310)==-5242848 &&
            renkidalma111(imageButton319)==-5242848 && renkidalma111(imageButton320)==-5242848 && renkidalma111(imageButton321)==-5242848 && renkidalma111(imageButton322)==-5242848 &&
            renkidalma111(imageButton327)==-5242848 && renkidalma111(imageButton328)==-5242848 && renkidalma111(imageButton329)==-5242848 && renkidalma111(imageButton330)==-5242848 &&
            renkidalma111(imageButton335)==-5242848 && renkidalma111(imageButton336)==-5242848 && renkidalma111(imageButton337)==-5242848 && renkidalma111(imageButton338)==-5242848 &&
            ...
            //kırmızı
            renkidalma111(imageButton315)==-10053376 && renkidalma111(imageButton316)==-10053376 && renkidalma111(imageButton317)==-10053376 && renkidalma111(imageButton318)==-10053376 &&
            renkidalma111(imageButton323)==-10053376 && renkidalma111(imageButton324)==-10053376 && renkidalma111(imageButton325)==-10053376 && renkidalma111(imageButton326)==-10053376 &&
            renkidalma111(imageButton331)==-10053376 && renkidalma111(imageButton332)==-10053376 && renkidalma111(imageButton333)==-10053376 && renkidalma111(imageButton334)==-10053376 &&
            ...
            renkidalma111(imageButton295)==-16776961 && renkidalma111(imageButton296)==-16776961 && renkidalma111(imageButton297)==-16776961 && renkidalma111(imageButton298)==-16776961 &&
            renkidalma111(imageButton303)==-16776961 && renkidalma111(imageButton304)==-16776961 && renkidalma111(imageButton305)==-16776961 && renkidalma111(imageButton306)==-16776961 &&
            renkidalma111(imageButton311)==-16776961 && renkidalma111(imageButton312)==-16776961 && renkidalma111(imageButton313)==-16776961 && renkidalma111(imageButton314)==-16776961
            //mavi
            )
            {
                try {
                    ...
                    if (deneme == 0) {
                        veritabani.execSQL("INSERT INTO oyun6 (id , color3sizee4 ) VALUES (1,$sayac)") // ilk başta veri yoksa tanımla
                    } else {
                        if (sayac < deneme) {  // veri varsa bunu yap
                            veritabani.execSQL("INSERT OR IGNORE INTO oyun6 (id , color3sizee4 ) VALUES (1,$sayac)")
                        }
                    }
                }
                catch (e : Exception){
    ...
    fun a333ust3 (view : View) {
        render(imageButton285, imageButton293,imageButton301,imageButton309, imageButton317, imageButton325, imageButton333, imageButton341 )
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun a666ust3 (view : View) {
        render(imageButton288, imageButton296,imageButton304,imageButton312, imageButton320, imageButton328, imageButton336, imageButton344 )
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun a222yan3 (view : View) {
        render(imageButton291, imageButton292,imageButton293,imageButton294, imageButton295, imageButton296, imageButton297, imageButton298 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a333yan3 (view : View) {
        render(imageButton299, imageButton300,imageButton301,imageButton302, imageButton303, imageButton304, imageButton305, imageButton306 )
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun a666yan3 (view : View) {
        render(imageButton323, imageButton324,imageButton325,imageButton326, imageButton327, imageButton328, imageButton329, imageButton330)
        sayac++
        textView6.text = ""+sayac
    }
    fun a777yan3 (view : View) {
        render(imageButton331, imageButton332,imageButton333,imageButton334, imageButton335, imageButton336, imageButton337, imageButton338)
        sayac++
        textView6.text = ""+sayac
    }
