...
import kotlinx.android.synthetic.main.activity_three_color_four2.*
import java.lang.Exception

class ThreeColorFour2 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_three_color_four2)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            imageButton315, imageButton284,imageButton285,imageButton286,
            imageButton291, imageButton324,imageButton293,imageButton294,
            imageButton299, imageButton300,imageButton333,imageButton302,
            imageButton307, imageButton308,imageButton309,imageButton342,

            imageButton320, imageButton321, imageButton322,
            imageButton327, imageButton329, imageButton330,
            imageButton335, imageButton336, imageButton338,
            imageButton343, imageButton344, imageButton345,

            imageButton319, imageButton328, imageButton337, imageButton346,
            imageButton283, imageButton288, imageButton289, imageButton290,
            imageButton295, imageButton292, imageButton297, imageButton298,
            imageButton303, imageButton304, imageButton301, imageButton306,
            imageButton311, imageButton312, imageButton313, imageButton310,

            imageButton287, imageButton316,imageButton317,imageButton318,
            imageButton323, imageButton296,imageButton325,imageButton326,
            imageButton331, imageButton332,imageButton305,imageButton334,
            imageButton339, imageButton340,imageButton341,imageButton314,
        )
        ...
        imageButton315.setImageResource(R.drawable.close)
        imageButton324.setImageResource(R.drawable.close)
        imageButton333.setImageResource(R.drawable.close)
        imageButton342.setImageResource(R.drawable.close)

        imageButton287.setImageResource(R.drawable.close)
        imageButton296.setImageResource(R.drawable.close)
        imageButton305.setImageResource(R.drawable.close)
        imageButton314.setImageResource(R.drawable.close)
        dene()
    var adRequest2 = AdRequest.Builder().build()

        InterstitialAd.load(this,"ca-app-pub-6469014985923539/8704828553", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma111(imageButton283)==-16776961 && renkidalma111(imageButton284)==-5242848 && renkidalma111(imageButton285)==-5242848 && renkidalma111(imageButton286)==-5242848 &&
            renkidalma111(imageButton291)==-5242848 && renkidalma111(imageButton292)==-16776961 && renkidalma111(imageButton293)==-5242848 && renkidalma111(imageButton294)==-5242848 &&
            renkidalma111(imageButton299)==-5242848 && renkidalma111(imageButton300)==-5242848 && renkidalma111(imageButton301)==-16776961 && renkidalma111(imageButton302)==-5242848 &&
            ...
            renkidalma111(imageButton327)==-5242848 && renkidalma111(imageButton328)==-16776961 && renkidalma111(imageButton329)==-5242848 && renkidalma111(imageButton330)==-5242848 &&
            renkidalma111(imageButton335)==-5242848 && renkidalma111(imageButton336)==-5242848 && renkidalma111(imageButton337)==-16776961 && renkidalma111(imageButton338)==-5242848 &&
            renkidalma111(imageButton343)==-5242848 && renkidalma111(imageButton344)==-5242848 && renkidalma111(imageButton345)==-5242848 && renkidalma111(imageButton346)==-16776961 &&
            //kırmızı
            renkidalma111(imageButton315)==-5242848 && renkidalma111(imageButton316)==-10053376 && renkidalma111(imageButton317)==-10053376 && renkidalma111(imageButton318)==-10053376 &&
            ...
            renkidalma111(imageButton331)==-10053376 && renkidalma111(imageButton332)==-10053376 && renkidalma111(imageButton333)==-5242848 && renkidalma111(imageButton334)==-10053376 &&
            renkidalma111(imageButton339)==-10053376 && renkidalma111(imageButton340)==-10053376 && renkidalma111(imageButton341)==-10053376 && renkidalma111(imageButton342)==-5242848 &&
            //yesil
            renkidalma111(imageButton287)==-10053376 && renkidalma111(imageButton288)==-16776961 && renkidalma111(imageButton289)==-16776961 && renkidalma111(imageButton290)==-16776961 &&
            renkidalma111(imageButton295)==-16776961 && renkidalma111(imageButton296)==-10053376 && renkidalma111(imageButton297)==-16776961 && renkidalma111(imageButton298)==-16776961 &&
            ...
            renkidalma111(imageButton311)==-16776961 && renkidalma111(imageButton312)==-16776961 && renkidalma111(imageButton313)==-16776961 && renkidalma111(imageButton314)==-10053376
        //mavi
        )
        {
            try {
    ...
    fun a111ust3 (view : View) {
        render2( imageButton291,imageButton299,imageButton307,  imageButton323, imageButton331, imageButton339 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a222ust3 (view : View) {
        render2(imageButton284, imageButton300,imageButton308, imageButton316,  imageButton332, imageButton340 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a333ust3 (view : View) {
        render2(imageButton285, imageButton293,imageButton309, imageButton317, imageButton325, imageButton341 )
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun a666ust3 (view : View) {
        render2(imageButton288, imageButton304,imageButton312, imageButton320,  imageButton336, imageButton344 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a777ust3 (view : View) {
        render2(imageButton289, imageButton297,imageButton313, imageButton321, imageButton329,  imageButton345 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a888ust3 (view : View) {
        render2(imageButton290, imageButton298,imageButton306, imageButton322, imageButton330, imageButton338 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a111yan3 (view : View) {
        render2( imageButton284,imageButton285,imageButton286,  imageButton288, imageButton289, imageButton290 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a222yan3 (view : View) {
        render2(imageButton291, imageButton293,imageButton294, imageButton295,  imageButton297, imageButton298 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a333yan3 (view : View) {
        render2(imageButton299, imageButton300,imageButton302, imageButton303, imageButton304,  imageButton306 )
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun a666yan3 (view : View) {
        render2(imageButton323, imageButton325,imageButton326, imageButton327,  imageButton329, imageButton330)
        sayac++
        textView6.text = ""+sayac
    }
    fun a777yan3 (view : View) {
        render2(imageButton331, imageButton332,imageButton334, imageButton335, imageButton336,  imageButton338)
        sayac++
        textView6.text = ""+sayac
    }

    fun a888yan3 (view : View) {
        render2(imageButton339, imageButton340,imageButton341, imageButton343, imageButton344, imageButton345)
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun carprazsagust5 (view : View) {
        rendercarpraz(imageButton342, imageButton333,imageButton324, imageButton315, imageButton314, imageButton305,imageButton296,imageButton287)
        sayac++
        textView6.text = ""+sayac
    }
    fun carprazsolalt5 (view : View) {
        rendercarpraz(imageButton287, imageButton296,imageButton305, imageButton314, imageButton315, imageButton324,imageButton333,imageButton342)
        sayac++
        textView6.text = ""+sayac
    }
