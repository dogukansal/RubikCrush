...
import kotlinx.android.synthetic.main.activity_four_color_three2.*
import java.lang.Exception

class FourColorThree2 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_four_color_three2)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            imageButton430, imageButton413, imageButton414, imageButton418, imageButton437, imageButton420,imageButton424, imageButton425, imageButton444,

            imageButton433, imageButton416, imageButton417, imageButton421,imageButton440 , imageButton423, imageButton427, imageButton428,imageButton447 ,

            imageButton415, imageButton431, imageButton432, imageButton436,imageButton422 , imageButton438, imageButton442, imageButton443, imageButton429,

            imageButton412, imageButton434, imageButton435, imageButton439, imageButton419, imageButton441, imageButton445, imageButton446, imageButton426)
        for (z in 0..63){
            val a = (0..13).random()
            rnds.add (a)
        ...
        imageButton415.setImageResource(R.drawable.close)
        imageButton422.setImageResource(R.drawable.close)
        imageButton429.setImageResource(R.drawable.close)

        imageButton430.setImageResource(R.drawable.close)
        imageButton437.setImageResource(R.drawable.close)
        imageButton444.setImageResource(R.drawable.close)
    ...
    var adRequest2 = AdRequest.Builder().build()
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/7661734840", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma1(imageButton412)==-16777216 && renkidalma1(imageButton413)==-5242848 && renkidalma1(imageButton424)==-5242848 &&
            renkidalma1(imageButton414)==-5242848 && renkidalma1(imageButton419)==-16777216 && renkidalma1(imageButton425)==-5242848 &&
            renkidalma1(imageButton418)==-5242848 && renkidalma1(imageButton420)==-5242848 && renkidalma1(imageButton426)==-16777216 &&
            //kırmızı
            renkidalma1(imageButton433)==-16776961 &&  renkidalma1(imageButton439)==-16777216 &&  renkidalma1(imageButton445)==-16777216 &&
            renkidalma1(imageButton434)==-16777216 &&  renkidalma1(imageButton440)==-16776961 &&  renkidalma1(imageButton446)==-16777216 &&
            renkidalma1(imageButton435)==-16777216 &&  renkidalma1(imageButton441)==-16777216 &&  renkidalma1(imageButton447)==-16776961 &&
            //siyah

            renkidalma1(imageButton415)==-10053376 && renkidalma1(imageButton421)==-16776961 && renkidalma1(imageButton427)==-16776961 &&
            renkidalma1(imageButton416)==-16776961 && renkidalma1(imageButton422)==-10053376 && renkidalma1(imageButton428)==-16776961 &&
            renkidalma1(imageButton417)==-16776961 && renkidalma1(imageButton423)==-16776961 && renkidalma1(imageButton429)==-10053376 &&
            //mavi

            renkidalma1(imageButton430)==-5242848 && renkidalma1(imageButton436)==-10053376 && renkidalma1(imageButton442)==-10053376 &&
            renkidalma1(imageButton431)==-10053376 && renkidalma1(imageButton437)==-5242848 && renkidalma1(imageButton443)==-10053376 &&
            renkidalma1(imageButton432)==-10053376 && renkidalma1(imageButton438)==-10053376 && renkidalma1(imageButton444)==-5242848 )
        //yesil

        {
            try {
                ...
                if (deneme == 0) {
                    veritabani.execSQL("INSERT INTO oyun3 (id , color4sizee3 ) VALUES (1,$sayac)") // ilk başta veri yoksa tanımla
                } else {
                    if (sayac < deneme) {  // veri varsa bunu yap
                        veritabani.execSQL("INSERT OR IGNORE INTO oyun3 (id , color4sizee3 ) VALUES (1,$sayac)")
                    }
                }
            }
            catch (e : Exception){
    ...
    fun a11ust (view : View) {
        render2( imageButton418, imageButton424,  imageButton436, imageButton442)
        sayac++
        textView8.text = ""+sayac
    }
    fun a22ust (view : View) {
        render2(imageButton413,  imageButton425, imageButton431,  imageButton443 )
        sayac++
        textView8.text = ""+sayac
    }
    ...
    fun a55ust (view : View) {
        render2(imageButton416,  imageButton428, imageButton434,  imageButton446)
        sayac++
        textView8.text = ""+sayac
    }
    fun a66ust (view : View) {
        render2(imageButton417, imageButton423,  imageButton435, imageButton441,)
        sayac++
        textView8.text = ""+sayac
    }

    fun a11yan (view : View) {
        render2( imageButton413,imageButton414, imageButton416, imageButton417 )
        sayac++
        textView8.text = ""+sayac
    }
    fun a22yan (view : View) {
        render2(imageButton418,  imageButton420, imageButton421,  imageButton423 )
        sayac++
        textView8.text = ""+sayac
    }
    ...
    fun a55yan (view : View) {
        render2(imageButton436,  imageButton438, imageButton439,  imageButton441)
        sayac++
        textView8.text = ""+sayac
    }
    fun a66yan (view : View) {
        render2(imageButton442, imageButton443,  imageButton445, imageButton446 )
        sayac++
        textView8.text = ""+sayac
    }
    ...
    fun carprazsolalt3  (view : View) {
        rendercarpraz(imageButton415, imageButton422, imageButton429, imageButton430, imageButton437, imageButton444)
        sayac++
        textView8.text = ""+sayac
    }
    fun carprazsagust3  (view : View) {
        rendercarpraz(imageButton444, imageButton437, imageButton430, imageButton429, imageButton422, imageButton415)
        sayac++
        textView8.text = ""+sayac
    }
