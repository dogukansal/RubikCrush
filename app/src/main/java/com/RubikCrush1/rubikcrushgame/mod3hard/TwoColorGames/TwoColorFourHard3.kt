...
import kotlinx.android.synthetic.main.activity_two_color_four_hard3.*
import java.lang.Exception

class TwoColorFourHard3 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_two_color_four_hard3)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            ...
            //
            , imageButton99,  imageButton106, imageButton107, imageButton113, imageButton115
            , imageButton120, imageButton121, imageButton122, imageButton133, imageButton117
            , imageButton134, imageButton135, imageButton140, imageButton142, imageButton148
            , imageButton149, imageButton156, imageButton124, imageButton131, imageButton138

            , imageButton100, imageButton108, imageButton109, imageButton116, imageButton118
            , imageButton125, imageButton126, imageButton127, imageButton128, imageButton129
            , imageButton130, imageButton137, imageButton139, imageButton146
            ...
            , imageButton114, imageButton123, imageButton132, imageButton141
        )
        for (z in 0..63){
            val a = (0..15).random()
            rnds.add (a)
        ...
        imageButton191.performClick()
        imageButton167.performClick()
        imageButton176.performClick()
        imageButton175.performClick()
    ...
    var adRequest2 = AdRequest.Builder().build()
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/8616869072", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma111(imageButton96)==-16776961 && renkidalma111(imageButton97)==-16776961 && renkidalma111(imageButton98)==-16776961 && renkidalma111(imageButton99)==-5242848 &&
            ...
            renkidalma111(imageButton112)==-16776961 && renkidalma111(imageButton113)==-5242848 && renkidalma111(imageButton114)==-16776961 && renkidalma111(imageButton115)==-5242848 &&
            ...
            renkidalma111(imageButton140)==-5242848 && renkidalma111(imageButton141)==-16776961 && renkidalma111(imageButton142)==-5242848 && renkidalma111(imageButton143)==-16776961 &&
            ...
            renkidalma111(imageButton116)==-16776961 && renkidalma111(imageButton117)==-5242848 && renkidalma111(imageButton118)==-16776961 && renkidalma111(imageButton119)==-5242848 &&
            ...
            renkidalma111(imageButton136)==-5242848 && renkidalma111(imageButton137)==-16776961 && renkidalma111(imageButton138)==-5242848 && renkidalma111(imageButton139)==-16776961 &&
    ...
    fun a222ust (view : View) {
        render1(imageButton113,imageButton121, imageButton129, imageButton137 )
        sayac++
        textView3.text = ""+sayac
    }
    fun a333ust (view : View) {
        render1( imageButton106,imageButton122, imageButton130, imageButton146)
        sayac++
        textView3.text = ""+sayac
    }
    ...
    fun a666ust (view : View) {
        render1( imageButton109,imageButton125, imageButton133, imageButton149 )
        sayac++
        textView3.text = ""+sayac
    }
    fun a777ust (view : View) {
        render1(imageButton118,imageButton126, imageButton134, imageButton142)
        sayac++
        textView3.text = ""+sayac
    }
    ...
    fun a222yan (view : View) {
        render1( imageButton106,imageButton107, imageButton108, imageButton109 )
        sayac++
        textView3.text = ""+sayac
    }
    fun a333yan (view : View) {
        render1(imageButton113,imageButton115, imageButton116, imageButton118 )
        sayac++
        textView3.text = ""+sayac
    }
    ...
    fun a666yan (view : View) {
        render1( imageButton137,imageButton139, imageButton140, imageButton142)
        sayac++
        textView3.text = ""+sayac
    }
    fun a777yan (view : View) {
        render1( imageButton146,imageButton147, imageButton148, imageButton149)
        sayac++
        textView3.text = ""+sayac
    }
