...
import kotlinx.android.synthetic.main.activity_three_color_three_hard3.*
import java.lang.Exception

class ThreeColorThreeHard3 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_three_color_three_hard3)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            imageButton226, imageButton249,
            imageButton232, imageButton244,
            imageButton236, imageButton237,
            ...
            imageButton227, imageButton231, imageButton238,
            imageButton233, imageButton245,imageButton252,
             imageButton240, imageButton241,

            imageButton228, imageButton229, imageButton235,//alındı
             imageButton250,imageButton239, imageButton234,
            imageButton256,
            imageButton242, imageButton243 )
        for (z in 0..35){
            val a = (0..11).random()
            rnds.add (a)
        ...
        imageButton379.performClick()
        imageButton265.performClick()
        imageButton272.performClick()
        imageButton271.performClick()
    ...
    var adRequest2 = AdRequest.Builder().build()
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/8342015832", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma1(imageButton224)==-16776961 && renkidalma1(imageButton225)==-16776961 && renkidalma1(imageButton226)==-5242848 &&
            renkidalma1(imageButton230)==-16776961 && renkidalma1(imageButton231)==-16776961 && renkidalma1(imageButton232)==-5242848 &&
            ...
            renkidalma1(imageButton251)==-5242848 &&  renkidalma1(imageButton252)==-16776961 &&  renkidalma1(imageButton253)==-16776961 &&
            ...
            renkidalma1(imageButton233)==-16776961 && renkidalma1(imageButton234)==-10053376 && renkidalma1(imageButton235)==-10053376 &&
            renkidalma1(imageButton239)==-10053376 && renkidalma1(imageButton240)==-16776961 && renkidalma1(imageButton241)==-16776961 &&
            //mavi

            renkidalma1(imageButton248)==-5242848 && renkidalma1(imageButton249)==-5242848 && renkidalma1(imageButton250)==-10053376 &&
    ...
    fun a22ust3 (view : View) {
        render2(  imageButton237, imageButton243 )
        sayac++
        textView5.text = ""+sayac
    }
    ...
    fun a55ust3 (view : View) {
        render2( imageButton240, imageButton246)
        sayac++
        textView5.text = ""+sayac
    }
    ...
    fun a22yan3 (view : View) {
        render2(  imageButton232, imageButton233 )
        sayac++
        textView5.text = ""+sayac
    }
    ...
    fun a55yan3 (view : View) {
        render2(  imageButton250, imageButton251)
        sayac++
        textView5.text = ""+sayac
    }
