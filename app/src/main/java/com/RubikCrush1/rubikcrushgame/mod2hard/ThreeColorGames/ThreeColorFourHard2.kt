package com.RubikCrush1.rubikcrushgame.mod2hard.ThreeColorGames
...
import kotlinx.android.synthetic.main.activity_three_color_four_hard2.*
import java.lang.Exception

class ThreeColorFourHard2 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_three_color_four_hard2)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            imageButton318, imageButton284,imageButton285,imageButton286,
            imageButton291, imageButton325,imageButton293,imageButton294,
            imageButton299, imageButton300,imageButton332,imageButton302,
            imageButton307, imageButton308,imageButton309,imageButton339,
            ...
            imageButton283, imageButton288, imageButton289, imageButton287,

            imageButton295, imageButton292, imageButton296, imageButton298,
            imageButton303, imageButton305, imageButton301, imageButton306,
            imageButton314, imageButton312, imageButton313, imageButton310,

            imageButton290, imageButton316,imageButton317,imageButton315,
            imageButton323, imageButton297,imageButton324,imageButton326,
            imageButton331, imageButton333,imageButton304,imageButton334,
            imageButton342, imageButton340,imageButton341,imageButton311,
        )
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/5503950140", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma111(imageButton283)==-16776961 && renkidalma111(imageButton284)==-5242848 && renkidalma111(imageButton285)==-5242848 && renkidalma111(imageButton286)==-5242848 &&
            ...
            renkidalma111(imageButton323)==-10053376 && renkidalma111(imageButton324)==-10053376 && renkidalma111(imageButton325)==-5242848 && renkidalma111(imageButton326)==-10053376 &&
            renkidalma111(imageButton331)==-10053376 && renkidalma111(imageButton332)==-5242848 && renkidalma111(imageButton333)==-10053376 && renkidalma111(imageButton334)==-10053376 &&
            renkidalma111(imageButton339)==-5242848 && renkidalma111(imageButton340)==-10053376 && renkidalma111(imageButton341)==-10053376 && renkidalma111(imageButton342)==-10053376 &&
            //yesil
            renkidalma111(imageButton287)==-16776961 && renkidalma111(imageButton288)==-16776961 && renkidalma111(imageButton289)==-16776961 && renkidalma111(imageButton290)==-10053376 &&
            renkidalma111(imageButton295)==-16776961 && renkidalma111(imageButton296)==-16776961 && renkidalma111(imageButton297)==-10053376 && renkidalma111(imageButton298)==-16776961 &&
            renkidalma111(imageButton303)==-16776961 && renkidalma111(imageButton304)==-10053376 && renkidalma111(imageButton305)==-16776961 && renkidalma111(imageButton306)==-16776961 &&
        ...
        )
        {
            try {
                var deneme: Int = 0
                val veritabani = this.openOrCreateDatabase("DENEME3", Context.MODE_PRIVATE, null)
    ...
    fun a111ust3 (view : View) {
        render2( imageButton291,imageButton299,imageButton307,  imageButton315, imageButton323, imageButton331 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a222ust3 (view : View) {
        render2(imageButton284, imageButton300,imageButton308, imageButton316,  imageButton324, imageButton340 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a333ust3 (view : View) {
        render2(imageButton285, imageButton293,imageButton309, imageButton317, imageButton333, imageButton341 )
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun a666ust3 (view : View) {
        render2(imageButton288, imageButton296,imageButton312, imageButton320,  imageButton336, imageButton344 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a777ust3 (view : View) {
        render2(imageButton289, imageButton305,imageButton313, imageButton321, imageButton329,  imageButton345 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a888ust3 (view : View) {
        render2(imageButton298, imageButton306,imageButton314, imageButton322, imageButton330, imageButton338 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a111yan3 (view : View) {
        render2( imageButton284,imageButton285,imageButton286,  imageButton287, imageButton288, imageButton289 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a222yan3 (view : View) {
        render2(imageButton291, imageButton293,imageButton294, imageButton295,  imageButton296, imageButton298 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a333yan3 (view : View) {
        render2(imageButton299, imageButton300,imageButton302, imageButton303, imageButton305,  imageButton306 )
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun a666yan3 (view : View) {
        render2(imageButton323, imageButton324,imageButton326, imageButton327,  imageButton329, imageButton330)
        sayac++
        textView6.text = ""+sayac
    }
    fun a777yan3 (view : View) {
        render2(imageButton331, imageButton333,imageButton334, imageButton335, imageButton336,  imageButton338)
        sayac++
        textView6.text = ""+sayac
    }

    fun a888yan3 (view : View) {
        render2(imageButton340, imageButton341,imageButton342, imageButton343, imageButton344, imageButton345)
        sayac++
        textView6.text = ""+sayac
    }
