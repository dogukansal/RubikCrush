...
import kotlinx.android.synthetic.main.activity_two_color_three_hard2.*

class TwoColorThreeHard2 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_two_color_three_hard2)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            ...
            ,  imageButton43, imageButton25, imageButton28   //mavi kısmı
            ,  imageButton31, imageButton34, imageButton50

            ,  imageButton42, imageButton41, imageButton24
            ,  imageButton46, imageButton47, imageButton29
            ,  imageButton30, imageButton48, imageButton49
            ,  imageButton35, imageButton52, imageButton51
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/1045979747", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma1(imageButton38)==-16776961 && renkidalma1(imageButton40)==-5242848 && renkidalma1(imageButton22)==-16776961 &&
            ...
            //kırmızı
            renkidalma1(imageButton41)==-16776961 && renkidalma1(imageButton43)==-5242848 && renkidalma1(imageButton51)==-16776961 &&
            ...
            renkidalma1(imageButton42)==-16776961 && renkidalma1(imageButton28)==-5242848 && renkidalma1(imageButton48)==-16776961 &&
    ...
    fun a11ust (view : View) {
        render2(imageButton44, imageButton45, imageButton48, imageButton49)
        sayac++
        textView2.text = ""+sayac
    }
    ...
    fun a66ust (view : View) {
        render2( imageButton46, imageButton47, imageButton53, imageButton54)
        sayac++
        textView2.text = ""+sayac
    }
    fun a11yan (view : View) {
        render2( imageButton42,imageButton41,imageButton40, imageButton39 )
        sayac++
        textView2.text = ""+sayac
    }
    fun a22yan (view : View) {
        render2(imageButton46,  imageButton24, imageButton23,  imageButton44 )
        sayac++
        textView2.text = ""+sayac
    }
    ...
    fun a66yan (view : View) {
        render2(imageButton51, imageButton52, imageButton57, imageButton56)
        sayac++
        textView2.text = ""+sayac
    }
