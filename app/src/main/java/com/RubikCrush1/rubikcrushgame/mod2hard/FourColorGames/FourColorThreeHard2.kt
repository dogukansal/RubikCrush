...
import kotlinx.android.synthetic.main.activity_four_color_three_hard2.*
import java.lang.Exception

class FourColorThreeHard2 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_four_color_three_hard2)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            imageButton432, imageButton413, imageButton414, imageButton418, imageButton437, imageButton420,imageButton424, imageButton425, imageButton442,

            imageButton433, imageButton416, imageButton415, imageButton421,imageButton440 , imageButton423, imageButton429, imageButton428,imageButton447 ,

            imageButton417, imageButton431, imageButton430, imageButton436,imageButton422 , imageButton438, imageButton444, imageButton443, imageButton427,
    ...
    var adRequest2 = AdRequest.Builder().build()
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/5035571504", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma1(imageButton412)==-16777216 && renkidalma1(imageButton413)==-5242848 && renkidalma1(imageButton424)==-5242848 &&
            ...
            renkidalma1(imageButton417)==-10053376 && renkidalma1(imageButton423)==-16776961 && renkidalma1(imageButton429)==-16776961 &&
            //mavi

            renkidalma1(imageButton430)==-10053376 && renkidalma1(imageButton436)==-10053376 && renkidalma1(imageButton442)==-5242848 &&
    ...
    fun a11ust (view : View) {
        render2( imageButton418, imageButton424,  imageButton430, imageButton436)
        sayac++
        textView8.text = ""+sayac
    }
    ...
    fun a66ust (view : View) {
        render2(imageButton423, imageButton429,  imageButton435, imageButton441,)
        sayac++
        textView8.text = ""+sayac
    }

    fun a11yan (view : View) {
        render2( imageButton413,imageButton414, imageButton415, imageButton416 )
        sayac++
        textView8.text = ""+sayac
    }
    ...
    fun a66yan (view : View) {
        render2(imageButton443, imageButton444,  imageButton445, imageButton446 )
        sayac++
        textView8.text = ""+sayac
    }
