...
import kotlinx.android.synthetic.main.activity_three_color_three_hard2.*
import java.lang.Exception

class ThreeColorThreeHard2 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_three_color_three_hard2)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            imageButton225, imageButton226,imageButton244,  //42 49 56 yeşil
            imageButton230, imageButton232,imageButton249,
            imageButton236, imageButton237,imageButton254,
            ...
            imageButton228, imageButton227,
            imageButton233, imageButton235,
            imageButton241, imageButton240,

            imageButton248,  imageButton250,imageButton229,
            imageButton256, imageButton255, imageButton234,
            imageButton243, imageButton242,imageButton239 )
        for (z in 0..63){
            val a = (0..13).random()
            rnds.add (a)
        ...
        imageButton239.setImageResource(R.drawable.close)

        imageButton244.setImageResource(R.drawable.close)
    ...
    var adRequest2 = AdRequest.Builder().build()
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/4382440164", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma1(imageButton224)==-16776961 && renkidalma1(imageButton225)==-5242848 && renkidalma1(imageButton226)==-5242848 &&
            ...
            renkidalma1(imageButton227)==-16776961 && renkidalma1(imageButton228)==-16776961 && renkidalma1(imageButton229)==-10053376 &&
            renkidalma1(imageButton233)==-16776961 && renkidalma1(imageButton234)==-10053376 && renkidalma1(imageButton235)==-16776961 &&
            renkidalma1(imageButton239)==-10053376 && renkidalma1(imageButton240)==-16776961 && renkidalma1(imageButton241)==-16776961 &&
            //mavi

            renkidalma1(imageButton248)==-10053376 && renkidalma1(imageButton249)==-5242848 && renkidalma1(imageButton250)==-10053376 &&
            renkidalma1(imageButton254)==-5242848 && renkidalma1(imageButton255)==-10053376 && renkidalma1(imageButton256)==-10053376 &&
            renkidalma1(imageButton242)==-10053376 && renkidalma1(imageButton243)==-10053376 && renkidalma1(imageButton244)==-5242848 )
        //yesil
        {
            try {
                var deneme: Int = 0
    ...
    fun a11ust3 (view : View) {
        render2( imageButton230, imageButton236, imageButton242, imageButton248)
        sayac++
        textView5.text = ""+sayac
    }
    ...
    fun a66ust3 (view : View) {
        render2(imageButton235, imageButton241,  imageButton247, imageButton253)
        sayac++
        textView5.text = ""+sayac
    }

    fun a11yan3 (view : View) {
        render2(imageButton225,imageButton226, imageButton227, imageButton228 )
        sayac++
        textView5.text = ""+sayac
    }
    ...
    fun a66yan3 (view : View) {
        render2(imageButton255, imageButton256,  imageButton257, imageButton258)
        sayac++
        textView5.text = ""+sayac
    }
    ...
    fun carprazsagust2  (view : View) {
        rendercarpraz(imageButton254, imageButton249, imageButton244 , imageButton239 , imageButton234 , imageButton229)
    ...
    fun carprazsolalt2  (view : View) {
        rendercarpraz(imageButton229, imageButton234, imageButton239 , imageButton244 , imageButton249 , imageButton254)
        sayac++
        textView5.text = ""+sayac
    }
