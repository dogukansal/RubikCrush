package com.RubikCrush1.rubikcrushgame.mod2hard.TwoColorGames
...
import kotlinx.android.synthetic.main.activity_two_color_four_hard2.*

class TwoColorFourHard2 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_two_color_four_hard2)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            imageButton103, imageButton97,  imageButton98,  imageButton99,  imageButton104,imageButton110 , imageButton106, imageButton107
            , imageButton112, imageButton113, imageButton117, imageButton115, imageButton120, imageButton121, imageButton122,imageButton124

            , imageButton131, imageButton133, imageButton134, imageButton135, imageButton140, imageButton138, imageButton142, imageButton143
            , imageButton148, imageButton149,imageButton145 , imageButton151, imageButton156, imageButton157, imageButton158,  imageButton152

            ,imageButton96 , imageButton101, imageButton102, imageButton100, imageButton108, imageButton105, imageButton109, imageButton111
            , imageButton116, imageButton118,imageButton114 , imageButton119, imageButton127, imageButton125, imageButton126, imageButton123

            , imageButton132, imageButton129, imageButton130, imageButton128, imageButton136, imageButton141, imageButton137, imageButton139
            , imageButton144, imageButton146, imageButton150, imageButton147, imageButton155, imageButton153, imageButton154, imageButton159 )
        for (z in 0..63){
            val a = (0..17).random()
            rnds.add (a)
        ...
        imageButton117.setImageResource(R.drawable.close)
        imageButton124.setImageResource(R.drawable.close)

        imageButton131.setImageResource(R.drawable.close)
        imageButton138.setImageResource(R.drawable.close)
    ...
    var adRequest2 = AdRequest.Builder().build()
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/9826338534", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma111(imageButton96)==-16776961 && renkidalma111(imageButton97)==-5242848 && renkidalma111(imageButton98)==-5242848 && renkidalma111(imageButton99)==-5242848 &&
            ...
            //kırmızı
            renkidalma111(imageButton100)==-16776961 && renkidalma111(imageButton101)==-16776961 && renkidalma111(imageButton102)==-16776961 && renkidalma111(imageButton103)==-5242848 &&
            renkidalma111(imageButton108)==-16776961 && renkidalma111(imageButton109)==-16776961 && renkidalma111(imageButton110)==-5242848 && renkidalma111(imageButton111)==-16776961 &&
            renkidalma111(imageButton116)==-16776961 && renkidalma111(imageButton117)==-5242848 && renkidalma111(imageButton118)==-16776961 && renkidalma111(imageButton119)==-16776961 &&
            renkidalma111(imageButton124)==-5242848 && renkidalma111(imageButton125)==-16776961 && renkidalma111(imageButton126)==-16776961 && renkidalma111(imageButton127)==-16776961 &&
            renkidalma111(imageButton128)==-16776961 && renkidalma111(imageButton129)==-16776961 && renkidalma111(imageButton130)==-16776961 && renkidalma111(imageButton131)==-5242848 &&
            renkidalma111(imageButton136)==-16776961 && renkidalma111(imageButton137)==-16776961 && renkidalma111(imageButton138)==-5242848 && renkidalma111(imageButton139)==-16776961 &&
            renkidalma111(imageButton144)==-16776961 && renkidalma111(imageButton145)==-5242848 && renkidalma111(imageButton146)==-16776961 && renkidalma111(imageButton147)==-16776961 &&
            renkidalma111(imageButton152)==-5242848 && renkidalma111(imageButton153)==-16776961 && renkidalma111(imageButton154)==-16776961 && renkidalma111(imageButton155)==-16776961
        //mavi
        )
        {
            try {
    ...
    fun a111ust (view : View) {
        render2( imageButton104,imageButton112,imageButton120,  imageButton128, imageButton136, imageButton144 )
        sayac++
        textView3.text = ""+sayac
    }
    fun a222ust (view : View) {
        render2(imageButton97, imageButton113,imageButton121, imageButton129,  imageButton137, imageButton153 )
        sayac++
        textView3.text = ""+sayac
    }
    fun a333ust (view : View) {
        render2(imageButton98, imageButton106,imageButton122, imageButton130, imageButton146,  imageButton154 )
        sayac++
        textView3.text = ""+sayac
    }
    ...
    fun a666ust (view : View) {
        render2(imageButton101, imageButton109,imageButton125, imageButton133,  imageButton149, imageButton157 )
        sayac++
        textView3.text = ""+sayac
    }
    fun a777ust (view : View) {
        render2(imageButton102, imageButton118,imageButton126, imageButton134, imageButton142,  imageButton158 )
        sayac++
        textView3.text = ""+sayac
    }
    fun a888ust (view : View) {
        render2(imageButton111, imageButton119,imageButton127, imageButton135, imageButton143, imageButton151 )
        sayac++
        textView3.text = ""+sayac
    }
    fun a111yan (view : View) {
        render2( imageButton97,imageButton98,imageButton99,  imageButton100, imageButton101, imageButton102 )
        sayac++
        textView3.text = ""+sayac
    }
    fun a222yan (view : View) {
        render2(imageButton104, imageButton106,imageButton107, imageButton108,  imageButton109, imageButton111 )
        sayac++
        textView3.text = ""+sayac
    }
    fun a333yan (view : View) {
        render2(imageButton112, imageButton113,imageButton115, imageButton116, imageButton118,  imageButton119 )
        sayac++
        textView3.text = ""+sayac
    }
    ...
    fun a666yan (view : View) {
        render2(imageButton136, imageButton137,imageButton139, imageButton140,  imageButton142, imageButton143)
        sayac++
        textView3.text = ""+sayac
    }
    fun a777yan (view : View) {
        render2(imageButton144, imageButton146,imageButton147, imageButton148, imageButton149,  imageButton151)
        sayac++
        textView3.text = ""+sayac
    }
    fun a888yan (view : View) {
        render2(imageButton153, imageButton154,imageButton155, imageButton156, imageButton157, imageButton158)
        sayac++
        textView3.text = ""+sayac
    }
    ...
    fun carprazsolalt4 (view : View) {
        rendercarpraz(imageButton103, imageButton110,imageButton117, imageButton124, imageButton131, imageButton138, imageButton145, imageButton152)

        sayac++
        textView3.text = ""+sayac
    }
    fun carprazsagust4 (view : View) {
        rendercarpraz(imageButton152, imageButton145,imageButton138, imageButton131, imageButton124, imageButton117, imageButton110, imageButton103)
        sayac++
        textView3.text = ""+sayac
    }
