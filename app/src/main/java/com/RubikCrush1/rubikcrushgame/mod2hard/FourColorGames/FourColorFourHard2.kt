package com.RubikCrush1.rubikcrushgame.mod2hard.FourColorGames
...
import kotlinx.android.synthetic.main.activity_four_color_four_hard2.*

class FourColorFourHard2 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_four_color_four_hard2)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            imageButton507, imageButton473, imageButton474, imageButton475,
            imageButton480, imageButton514, imageButton482, imageButton483, //kırmızı
            imageButton488, imageButton489, imageButton521, imageButton491,
            imageButton496, imageButton497, imageButton498, imageButton528,

            imageButton508, imageButton477, imageButton478, imageButton476,
            imageButton484, imageButton517, imageButton485, imageButton487,
            imageButton492, imageButton494, imageButton526, imageButton495, //mavi
            imageButton503, imageButton501, imageButton502, imageButton535,

            imageButton479, imageButton505, imageButton506, imageButton504,
            imageButton512, imageButton486, imageButton513, imageButton515,
            imageButton520, imageButton522, imageButton493, imageButton523, // yesil
            imageButton531, imageButton529, imageButton530, imageButton500,
    ...
    var adRequest2 = AdRequest.Builder().build()
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/4546091695", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma111(imageButton472)==-16777216 && renkidalma111(imageButton473)==-5242848 && renkidalma111(imageButton474)==-5242848 && renkidalma111(imageButton475)==-5242848 &&
            ...
            renkidalma111(imageButton512)==-10053376 && renkidalma111(imageButton513)==-10053376 && renkidalma111(imageButton514)==-5242848 && renkidalma111(imageButton515)==-10053376 &&
            renkidalma111(imageButton520)==-10053376 && renkidalma111(imageButton521)==-5242848 && renkidalma111(imageButton522)==-10053376 && renkidalma111(imageButton523)==-10053376 &&
            renkidalma111(imageButton528)==-5242848 && renkidalma111(imageButton529)==-10053376 && renkidalma111(imageButton530)==-10053376 && renkidalma111(imageButton531)==-10053376 &&
            //yesil
            renkidalma111(imageButton476)==-16776961 && renkidalma111(imageButton477)==-16776961 && renkidalma111(imageButton478)==-16776961 && renkidalma111(imageButton479)==-10053376 &&
            renkidalma111(imageButton484)==-16776961 && renkidalma111(imageButton485)==-16776961 && renkidalma111(imageButton486)==-10053376 && renkidalma111(imageButton487)==-16776961 &&
            renkidalma111(imageButton492)==-16776961 && renkidalma111(imageButton493)==-10053376 && renkidalma111(imageButton494)==-16776961 && renkidalma111(imageButton495)==-16776961 &&
    ...
    fun a111ust (view : View) {
        render2( imageButton480,imageButton488,imageButton496,  imageButton504, imageButton512, imageButton520 )
        sayac++
        textView9.text = ""+sayac
    }
    fun a222ust (view : View) {
        render2(imageButton473, imageButton489,imageButton497, imageButton505,  imageButton513, imageButton529 )
        sayac++
        textView9.text = ""+sayac
    }
    fun a333ust (view : View) {
        render2(imageButton474, imageButton482,imageButton498, imageButton506, imageButton522,  imageButton530 )
        sayac++
        textView9.text = ""+sayac
    }
    ...
    fun a666ust (view : View) {
        render2(imageButton477, imageButton485,imageButton501, imageButton509,  imageButton525, imageButton533 )
        sayac++
        textView9.text = ""+sayac
    }
    fun a777ust (view : View) {
        render2(imageButton478, imageButton494,imageButton502, imageButton510, imageButton518,  imageButton534 )
        sayac++
        textView9.text = ""+sayac
    }
    fun a888ust (view : View) {
        render2(imageButton487, imageButton495,imageButton503, imageButton511, imageButton519, imageButton527 )
        sayac++
        textView9.text = ""+sayac
    }

    fun a111yan (view : View) {
        render2( imageButton473,imageButton474,imageButton475,  imageButton476, imageButton477, imageButton478 )
        sayac++
        textView9.text = ""+sayac
    }
    fun a222yan (view : View) {
        render2(imageButton480, imageButton482,imageButton483, imageButton484,  imageButton485, imageButton487 )
        sayac++
        textView9.text = ""+sayac
    }
    fun a333yan (view : View) {
        render2(imageButton488, imageButton489,imageButton491, imageButton492, imageButton494,  imageButton495 )
        sayac++
        textView9.text = ""+sayac
    }
    ...
    fun a666yan (view : View) {
        render2(imageButton512, imageButton513,imageButton515, imageButton516,  imageButton518, imageButton519)
        sayac++
        textView9.text = ""+sayac
    }
    fun a777yan (view : View) {
        render2(imageButton520, imageButton522,imageButton523, imageButton524, imageButton525,  imageButton527)
        sayac++
        textView9.text = ""+sayac
    }
    fun a888yan (view : View) {
        render2(imageButton529, imageButton530,imageButton531, imageButton532, imageButton533, imageButton534)
        sayac++
        textView9.text = ""+sayac
    }
