...
import kotlinx.android.synthetic.main.activity_three_color_three4.*
import java.lang.Exception

class ThreeColorThree4 : AppCompatActivity() {
    lateinit var mAdView : AdView
    private var mInterstitialAd: InterstitialAd? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_three_color_three4)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
            ...
            imageButton230, imageButton249, imageButton250,
            imageButton236,  imageButton238,imageButton243,
            imageButton245,  imageButton247, imageButton253,
            imageButton257, imageButton258, imageButton259,

            imageButton231, imageButton232,imageButton237, //alındı
            imageButton246, imageButton251, imageButton252, // alındı
            imageButton227, imageButton228, imageButton229,
            imageButton235, imageButton239, imageButton241,

            imageButton248, imageButton233, imageButton234,
            imageButton254, imageButton255, imageButton256,
            imageButton242, imageButton244, imageButton240 )
        for (z in 0..35){
            val a = (0..11).random()
            rnds.add (a)
        ...
        imageButton232.setImageResource(R.drawable.close)
        imageButton237.setImageResource(R.drawable.close)

        imageButton233.setImageResource(R.drawable.close)
        imageButton234.setImageResource(R.drawable.close)
        imageButton240.setImageResource(R.drawable.close)

        imageButton243.setImageResource(R.drawable.close)
        imageButton249.setImageResource(R.drawable.close)
        imageButton250.setImageResource(R.drawable.close)

        imageButton251.setImageResource(R.drawable.close)
        imageButton252.setImageResource(R.drawable.close)
        imageButton246.setImageResource(R.drawable.close)



        dene()
        var adRequest2 = AdRequest.Builder().build()
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/7799730983", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma1(imageButton224)==-5242848 && renkidalma1(imageButton225)==-5242848 && renkidalma1(imageButton226)==-5242848 &&
            renkidalma1(imageButton230)==-5242848 && renkidalma1(imageButton231)==-16776961 && renkidalma1(imageButton232)==-16776961 &&
            renkidalma1(imageButton236)==-5242848 && renkidalma1(imageButton237)==-16776961 && renkidalma1(imageButton238)==-5242848 &&
            renkidalma1(imageButton245)==-5242848 &&  renkidalma1(imageButton246)==-16776961 &&  renkidalma1(imageButton247)==-5242848 &&
            renkidalma1(imageButton251)==-16776961 &&  renkidalma1(imageButton252)==-16776961 &&  renkidalma1(imageButton253)==-5242848 &&
            ...
            renkidalma1(imageButton233)==-10053376 && renkidalma1(imageButton234)==-10053376 && renkidalma1(imageButton235)==-16776961 &&
            renkidalma1(imageButton239)==-16776961 && renkidalma1(imageButton240)==-10053376 && renkidalma1(imageButton241)==-16776961 &&
            //mavi

            renkidalma1(imageButton248)==-10053376 && renkidalma1(imageButton249)==-5242848 && renkidalma1(imageButton250)==-5242848 &&
            renkidalma1(imageButton254)==-10053376 && renkidalma1(imageButton255)==-10053376 && renkidalma1(imageButton256)==-10053376 &&
            renkidalma1(imageButton242)==-10053376 && renkidalma1(imageButton243)==-5242848 && renkidalma1(imageButton244)==-10053376 )
        //yesil
        {
            try {
                var deneme: Int = 0
    ...
    fun a33ust3 (view : View) {
        render2(imageButton226, imageButton238, imageButton244, imageButton256)
        sayac++
        textView5.text = ""+sayac
    }
    fun a44ust3 (view : View) {
        render2(imageButton227, imageButton239, imageButton245, imageButton257)
        sayac++
        textView5.text = ""+sayac
    }
    ...
    fun a22yan3 (view : View) {
        render3(imageButton230,  imageButton235 )
        sayac++
        textView5.text = ""+sayac
    }
    fun a33yan3 (view : View) {
        render2(imageButton236, imageButton238, imageButton239, imageButton241)
        sayac++
        textView5.text = ""+sayac
    }
    fun a44yan3 (view : View) {
        render2(imageButton242, imageButton244 , imageButton245, imageButton247)
        sayac++
        textView5.text = ""+sayac
    }
    fun a55yan3 (view : View) {
        render3(imageButton248,  imageButton253)
        sayac++
        textView5.text = ""+sayac
    }
    ...
    fun carprazsolust2 (view : View) {
        rendercarpraz(imageButton234, imageButton233, imageButton232, imageButton231 )

        sayac++
        textView5.text = ""+sayac
    }
    fun carprazsagust2 (view : View) {
        rendercarpraz(imageButton231, imageButton232, imageButton233, imageButton234 )
        sayac++
        textView5.text = ""+sayac
    }
    fun carprazsolalt2 (view : View) {
        rendercarpraz(imageButton252, imageButton251, imageButton250, imageButton249 )

        sayac++
        textView5.text = ""+sayac
    }fun carprazsagalt2 (view : View) {
        rendercarpraz(imageButton249, imageButton250, imageButton251, imageButton252 )
        sayac++
        textView5.text = ""+sayac
    }
