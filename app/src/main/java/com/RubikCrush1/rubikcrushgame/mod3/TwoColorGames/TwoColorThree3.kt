...
import kotlinx.android.synthetic.main.activity_two_color_three3.*
import java.lang.Exception

class TwoColorThree3 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_two_color_three3)
        ...
        val butonsayisi : ArrayList<ImageButton> = arrayListOf<ImageButton>(
              imageButton40, imageButton22, imageButton23
            , imageButton45, imageButton26, imageButton27
            , imageButton32, imageButton33, imageButton53
            , imageButton36, imageButton37, imageButton57
            ...
            , imageButton41, imageButton24, imageButton25
            , imageButton28, imageButton29, imageButton47
            , imageButton48, imageButton30, imageButton31
            , imageButton34, imageButton35, imageButton52)
        for (z in 0..35){
            val a = (0..11).random()
            rnds.add (a)
    ...
    var adRequest2 = AdRequest.Builder().build()
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/5719242992", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma1(imageButton38)==-16776961 && renkidalma1(imageButton40)==-5242848 && renkidalma1(imageButton22)==-5242848 &&
            renkidalma1(imageButton23)==-5242848 && renkidalma1(imageButton26)==-5242848 && renkidalma1(imageButton56)==-16776961 &&
            renkidalma1(imageButton36)==-5242848 && renkidalma1(imageButton54)==-16776961 && renkidalma1(imageButton32)==-5242848 &&
            ...
            renkidalma1(imageButton37)==-5242848 &&  renkidalma1(imageButton57)==-5242848 &&  renkidalma1(imageButton55)==-16776961 &&
            //kırmızı
            ...
            renkidalma1(imageButton42)==-5242848 && renkidalma1(imageButton28)==-16776961 && renkidalma1(imageButton48)==-16776961 &&
            renkidalma1(imageButton25)==-16776961 && renkidalma1(imageButton50)==-5242848 && renkidalma1(imageButton30)==-16776961 &&
            renkidalma1(imageButton34)==-16776961 && renkidalma1(imageButton29)==-16776961 && renkidalma1(imageButton31)==-16776961 )
        //mavi
        {
            try {
                var deneme: Int = 0
    ...
    fun a22ust (view : View) {
        render2( imageButton22, imageButton26, imageButton30, imageButton34 )
        sayac++
        textView2.text = ""+sayac
    }
    ...
    fun a55ust (view : View) {
        render2( imageButton25, imageButton29, imageButton33, imageButton37)
        sayac++
        textView2.text = ""+sayac
    }
    ...
    fun a22yan (view : View) {
        render2( imageButton22, imageButton23, imageButton24, imageButton25  )
        sayac++
        textView2.text = ""+sayac
    }
    ...
    fun a55yan (view : View) {
        render2(imageButton34, imageButton35, imageButton36, imageButton37)
        sayac++
        textView2.text = ""+sayac
    }
    ...
    fun carprazsolust (view : View) {
        rendercarpraz(imageButton38, imageButton39, imageButton42, imageButton43)
        sayac++
        textView2.text = ""+sayac
    }
    fun carprazsagust (view : View) {
        rendercarpraz(imageButton43, imageButton42, imageButton39, imageButton38)
        sayac++
        textView2.text = ""+sayac
    }
    fun carprazsolalt (view : View) {
        rendercarpraz(imageButton50, imageButton51, imageButton56, imageButton55)
        sayac++
        textView2.text = ""+sayac
    }
    fun carprazsagalt (view : View) {
        rendercarpraz(imageButton55, imageButton56, imageButton51, imageButton50)
        sayac++
        textView2.text = ""+sayac
    }
