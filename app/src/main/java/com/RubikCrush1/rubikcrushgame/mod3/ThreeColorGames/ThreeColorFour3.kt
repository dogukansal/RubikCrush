...
import kotlinx.android.synthetic.main.activity_three_color_four3.*
import java.lang.Exception

class ThreeColorFour3 : AppCompatActivity() {
    lateinit var mAdView : AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_three_color_four3)
    ...
    var adRequest2 = AdRequest.Builder().build()
        ...
        InterstitialAd.load(this,"ca-app-pub-6469014985923539/8944651060", adRequest2, object : InterstitialAdLoadCallback() {
    ...
    fun kontrol(){
        if( renkidalma111(imageButton283)==-16776961 && renkidalma111(imageButton284)==-16776961 && renkidalma111(imageButton285)==-16776961 && renkidalma111(imageButton286)==-5242848 &&
            ...
            renkidalma111(imageButton299)==-16776961 && renkidalma111(imageButton300)==-5242848 && renkidalma111(imageButton301)==-5242848 && renkidalma111(imageButton302)==-5242848 &&
            ...
            renkidalma111(imageButton327)==-5242848 && renkidalma111(imageButton328)==-5242848 && renkidalma111(imageButton329)==-5242848 && renkidalma111(imageButton330)==-16776961 &&
            ...
            renkidalma111(imageButton323)==-5242848 && renkidalma111(imageButton324)==-10053376 && renkidalma111(imageButton325)==-10053376 && renkidalma111(imageButton326)==-10053376 &&
            ...
            renkidalma111(imageButton303)==-16776961 && renkidalma111(imageButton304)==-16776961 && renkidalma111(imageButton305)==-16776961 && renkidalma111(imageButton306)==-10053376 &&
    ...
    fun a222ust3 (view : View) {
        render1( imageButton292,imageButton300,imageButton308, imageButton316, imageButton324, imageButton332 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a333ust3 (view : View) {
        render1( imageButton293,imageButton301,imageButton309, imageButton317, imageButton325, imageButton333 )
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun a666ust3 (view : View) {
        render1( imageButton296,imageButton304,imageButton312, imageButton320, imageButton328, imageButton336 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a777ust3 (view : View) {
        render1( imageButton297,imageButton305,imageButton313, imageButton321, imageButton329, imageButton337 )
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun a222yan3 (view : View) {
        render1( imageButton292,imageButton293,imageButton294, imageButton295, imageButton296, imageButton297 )
        sayac++
        textView6.text = ""+sayac
    }
    fun a333yan3 (view : View) {
        render1( imageButton300,imageButton301,imageButton302, imageButton303, imageButton304, imageButton305 )
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun a666yan3 (view : View) {
        render1( imageButton324,imageButton325,imageButton326, imageButton327, imageButton328, imageButton329)
        sayac++
        textView6.text = ""+sayac
    }
    fun a777yan3 (view : View) {
        render1( imageButton332,imageButton333,imageButton334, imageButton335, imageButton336, imageButton337)
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun carprazsolust5 (view : View) {
        render1(imageButton283, imageButton284,imageButton285, imageButton288, imageButton289, imageButton290 )
        sayac++
        textView6.text = ""+sayac
    }
    ...
    fun carprazsolalt5 (view : View) {
        render1(imageButton339, imageButton340,imageButton341, imageButton344, imageButton345, imageButton346)
        sayac++
        textView6.text = ""+sayac
    }
